"*Somehow, ancient civilizations have found themselves whisked away into a world of cubes and magic...*"
...
- Ars Nouveau for spellcrafting and Malum for forbidden spirit-magic
- Unrestricted enchanting: many mutual exclusions have been removed
...
- Both types of Ars Nouveau teleportation scrolls have been made cheaper
- Press CTRL+V to find Millénaire villages, and CTRL+M to open the Millenaire info panel.
...
The Inline Suggestions feature of GitHub Copilot for Visual Studio Code was used in a limited capacity (free version has very limited tokens anyway) for the development of KubeJS scripts for this modpack. Copilot did not write the scripts, nor did any LLM create ideas for the pack.
